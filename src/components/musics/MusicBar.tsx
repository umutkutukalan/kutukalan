    ...
    <div className="w-full h-full rounded-xl p-4 flex flex-col justify-between overflow-hidden relative">
      ...
      <div className="w-full h-full flex flex-col justify-between z-100">
        <div className="flex flex-col gap-3">
          <div className="w-[clamp(10rem,8vw,20rem)] h-[clamp(10rem,8vw,20rem)] 3xl:w-[clamp(15rem,4vw,20rem)] 3xl:h-[clamp(15rem,4vw,20rem)] 4xl:w-[clamp(30rem,4vw,40rem)] 4xl:h-[clamp(30rem,4vw,40rem)] rounded-lg overflow-hidden">
            <img
              src={displayTrack?.musicImg}
              alt=""
