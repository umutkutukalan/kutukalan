import { gray, nixtio, sahnesen } from "../../utils";
import { BsChevronLeft } from "react-icons/bs";
import { BsChevronRight } from "react-icons/bs";

const HomeBorder = () => {
  return (
    <div className="w-full h-2/5 relative flex flex-col gap-1">
        ...
        <div className="relative w-full h-full overflow-hidden grid grid-cols-2 gap-2 items-center">
          ...
          <div className="rounded-xl bg-white/10 h-full relative overflow-hidden">
            ...
            <div className="absolute -bottom-10 left-1/2 -translate-x-1/2">
              <div className="w-80">
                <img src={nixtio} alt="" className="w-full h-full" />
              </div>
            </div>
          </div>
        </div>
        <div className="relative w-full h-full overflow-hidden grid grid-rows-2 gap-2">
          <div>
