...
import type { CompetenceProps } from "../../pages/Competencies";
import { garanticard, iphonechip, logo2, poppin, sabiroto } from "../../utils";
import { useGSAP } from "@gsap/react";
import gsap from "gsap";
import { useAudioPlayer } from "../../context/AudioPlayerContext";

const CompetenceHeader = ({ userResponse }: CompetenceProps) => {
        ...
        <div className="w-full flex items-end justify-between z-30 px-5 sm:px-15">
          <div className="flex flex-col banner">
            ...
            <div className="max-w-xl">
              <h3 className="text-xs sm:text-sm bg-gradient-to-r from-gray-400 via-gray-200 to-gray-400 text-transparent bg-clip-text">
                Özen, süreklilik ve amaç üzerine.
              </h3>
            </div>
          </div>
        </div>
