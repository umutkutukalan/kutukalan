...
import { gray, itstime } from "../../utils";
...
interface CompetenceBoxProps {
  competenceBox1: React.RefObject<HTMLLIElement | null>;
  competenceBox2: React.RefObject<HTMLLIElement | null>;
  competenceBox3: React.RefObject<HTMLLIElement | null>;
}

const CompetenceBox = ({ competenceBox1, competenceBox2, competenceBox3 }: CompetenceBoxProps) => {
  ...
  useGSAP(() => {
    if (
      !competenceBox1.current ||
      !competenceBox2.current ||
      !competenceBox3.current ||
      !sectionRef.current
    )
      return;
